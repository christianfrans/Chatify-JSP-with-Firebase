...
<body>
    <br><br><br><br><br><br>
    <div class="mainbanner mainbanner_h300 hidden-xs" style="background-image: url('https://wallpapercave.com/wp/wp1862825.jpg')">
        <div class="container">
            <br><br><br>
            <article class="content">

                <h4 style="font-size: 50pt">Welcome to Chatify</h4>
                <br>
                <h3 style="color: #fff; margin-left: 15px;">Entering The Yellow Sphere</h3>

                <h5 style="color: bisque; margin-left: 15px;">#1 Social Media Platform in South East Asia</h5>
                <br>
    ...
    <div class="mainbanner mainbanner_h140 hidden-lg" style="background-image: url('https://wallpapercave.com/wp/wp1862825.jpg')">
        <div class="section membership-intro">
            <div class="container1088">
                <div class="content">
                    <div class="row membership-row">
                        <div class="col m6 xs12">
                            <h4 style="font-size: 15pt">Welcome to Chatify</h4>
                            <br>
                            <h3 style="color: #fff; font-size: 7pt;">Entering The Yellow Sphere</h3>

                            <h5 style="color: bisque; font-size: 7pt;">#1 Social Media Platform in South East Asia</h5>
                            <br>
                            <a href="" class="btn--primary">Login</a>
                            <a href="" class="btn--primary">Register</a>
                        </div>
    ...
    <div class="ct-750 about-content pt_30">
        ...
        <h2 class="primary-heading text-center size_36 lh_43 ls_0 mt_30 mb_25 barlow semibold xs-mb_20">What is Chatify?
        </h2>

        <div class="ct-650">

            <p class="size_16 ls_0 lh_22 opensans text-justify mb_30 xs-size_14 xs-lh_19">
                Chatify adalah sebuah wadah yang dibuat oleh management Team Chatify sebagai tempat untuk bisa saling berkomunikasi, and berbagi informasi.
                <br /><br />
                <i>Chatify is community platform created by Team Chatify for all the people so that we can connected
                    each other, and sharing many information.</i>
            </p>
        </div>

        <h2 class="primary-heading text-center size_36 lh_43 ls_0 mt_30 mb_5 barlow semibold xs-mb_20">BE A PART OF US!
        </h2>

        <h3 class="text-center size_30 barlow semibold mb_25 grey"><i>#1 Social Media Platform in South East Asia</i>
        </h3>

        <div class="ct-650">

            <p class="size_16 ls_0 lh_22 opensans text-justify mb_30 xs-size_14 xs-lh_19">
                Chatify bertujuan menjembatani manusia yang ingin bertemu dengan manusia lain di seluruh dunia.
                <br /><br />
                <i>Chatify aims to bridge people who want to meet with another people all around the world. </i>
            </p>
        </div>

        <div class="text-center mb_80">
            <a href="" target="_blank" class="btn--primary btn-lg barlow bold">Download
                Now!</a>
        </div>
    </div>
</body>
...
<footer>
    <div class="footer">
        ...
        <div class="copyright center">
            <small>© 2021 MADE BY STUDENTS FROM CCIT - FTUI</small>
        </div>
    </div>
