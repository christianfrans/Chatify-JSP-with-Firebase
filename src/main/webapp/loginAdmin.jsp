        ...
        <div class="navbar__mobile headroom">
            <div class="navbar__mobile">
                <div class="navbar__li">
                    ...
                    <a href="chatifystore.html" class="navbar__a uppercase bold">Chatify Store</a>
...
<body>
    <br>
    <div class="main__wrapper page--contact pt_50 pb_40 xs-pt_30 xs-pb_30" style="background-image: url(https://w.wallhaven.cc/full/g8/wallhaven-g8lkkl.jpg); background-size: 130%; background-position-y: 1500px; background-position-x: 10px">

        <div class="ct-730">
            <h2 class="borlaw semibold size_36 ls_0 lh_43 mb_53 hidden-xs">Admin Login</h2>
            <form>
                ...
                <div class="row row_gutter15">
                    ...
                    <div class="col m6 xs12 col_gutter15 field_input">
                        ...
                        <div class="form-group mb_31 xs-mb_15" id="input_username">
                            <label class="barlow medium size_18 xs-size_14 ls_0 xs-lh_17 lh_22 xs-mb_5 mb_6">E -
                                mail</label>
                            <input class="form-control rubick" id="email" type="email" name="email"></input>
                        </div>
                    </div>
                ...
                <div class="row row_gutter15">
                    ...
                    <div class="col m6 xs12 col_gutter15 field_input">
                        ...
                        <div class="form-group mb_31 xs-mb_15" id="input_password">
                            <label class="barlow medium size_18 xs-size_14 ls_0 xs-lh_17 lh_22 xs-mb_5 mb_6">Password</label>
                            <input class="form-control rubick" id="password" type="password" name="password"></input>
                        </div>
                    </div>
                ...
                <div class="row row_gutter15 mb_50 xs-mb_30">
                    ...
                    <div class="col m12 col_gutter15">
                        <button name="submit" type="button" onclick="loginAdmin()" class="btn xs-size_16 size_24 ls_0 lh_29 xs-lh_19 barlow bold btn_w200">Login</button>
                    </div>
...
<script language="javascript">
    function loginAdmin() {
        if (document.getElementById("email").value == "adminchatify" &&
            document.getElementById("password").value == "adminchatify") {
