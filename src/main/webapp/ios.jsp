...
<body>
    <!-- DESKTOP -->
    <br><br><br><br><br><br>
    <div class="mainbanner mainbanner_h300 hidden-xs" style="background-image: url('https://w.wallhaven.cc/full/0j/wallhaven-0j2ppm.jpg')">
        <div class="container">
            <br/>
            <br/>
            <br/>
            <article class="content">
                ...
                <h1 style="color: orange;">Download Chatify for iOS</h1>

                <h5 style="color: white;">By installing Chatify, you are agreeing to our Terms &amp; Privacy Policy.</h5>
                <br>
                <a href="https://www.apple.com/id/ios/app-store/"><img src="https://img2.pngio.com/itunes-app-store-logo-sitech-itunes-app-store-png-4491_1552.png" alt="App Store" width="20%" /></a>
            </article>
        </div>
    </div>

    <!-- SMALLER / MOBILE -->
    <div class="mainbanner mainbanner_h140 hidden-lg" style="background-image: url('https://w.wallhaven.cc/full/0j/wallhaven-0j2ppm.jpg')">
                ...
                <div class="content">
                    <div class="row membership-row">
                        <article class="content">
                            ...
                            <h1 style="color: orange; font-size: 15pt;">Download Chatify for iOS</h1>

                            <h5 style="color: white; font-size: 7pt;">By installing Chatify, you are agreeing to our Terms &amp; Privacy Policy.</h5>
                            <br>
                            <a href="https://www.apple.com/id/ios/app-store/"><img src="https://img2.pngio.com/itunes-app-store-logo-sitech-itunes-app-store-png-4491_1552.png" alt="App Store" width="20%" /></a>
                        </article>
                    </div>
