        ...
        <div class="header__container">
            ...
            <div class="header__mid">
                ...
                <ul class="navbar flex vcenter" id="menu-header" data-selected-menu="">
                    ...
                    <li class="" data-value="match"><a href="chatifystore.html" class="navbar--a bold uppercase">Chatify Store</a></li>
                    <li class="" data-value="match"><a href="chatifytoday.html" class="navbar--a bold uppercase">Chatify Today</a></li>
                    <li class="" data-value="match"><a href="about.html" class="navbar--a bold uppercase">About</a></li>
...
<body>
    <div class="main__wrapper page--division" id="content">
        <div class="mainbanner mainbanner_h300 hidden-xs" style="background-image: url('https://d2slcw3kip6qmk.cloudfront.net/marketing/blog/2018Q4/optimize-team-communication/guest-post-6-ways-to-optimize-team-communication-header@2x.png')">
        </div>
        <div class="mainbanner mainbanner_h140 hidden-lg" style="background-image: url('https://d2slcw3kip6qmk.cloudfront.net/marketing/blog/2018Q4/optimize-team-communication/guest-post-6-ways-to-optimize-team-communication-header@2x.png')"></div>

        <div class="section introduction">
            <div class="container960">
                <div class="content row">
                    <div class="col m12">
                        <h2 class="primary-heading text-center size_36 lh_43 ls_0 mt_30 mb_25 barlow semibold xs-mb_20">
                            OUR GOALS</h2>
                        <blockquote class="quotes mb_30 xs-mb_20">

                            <div class="opensans size_20 ls_0 lh_27 text-center ">

                                <p>Connecting Everyone Worldwide</p>
                            </div>
                        </blockquote>
                        <div class="description opensans">
                            <div class="ct-650">

                                <div class="size_16 ls_0 lh_22 opensans text-justify mb_30 xs-size_14 xs-lh_19">

                                    <p>Chatify reshapes communication around the globe, allowing you to enjoy not only messaging but also free voice and video calls wherever you find yourself. So, on this website, the user can register their account and
                                        buy some stickers to make the communication more fun. The user can also see some articles about the world in the Chatify News.</p>
                                </div>
