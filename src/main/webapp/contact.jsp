        ...
        <div class="navbar__mobile headroom">
            ...
            <div class="navbar__mobile">
                <div class="navbar__li">
                    ...
                    <a href="windows.html" class="navbar__a uppercase bold" style="left: 175px;">WINDOWS</a>
...
<body>
    ...
    <div class="main__wrapper page--contact pt_50 pb_40 xs-pt_30 xs-pb_30">
        <div class="ct-730">
            <h2 class="borlaw semibold size_36 text-center ls_0 lh_43 mb_53 hidden-xs">How we can help?</h2>

            <h2 class="rubick medium size_24 text-center ls_0 lh_28 mb_34 hidden-lg">How we can help?</h2>

            <form name="userForm">
                <div class="row row_gutter15">
                    <div class="col m6 xs12 col_gutter15 field_input">
                        <div class="form-group mb_31 xs-mb_15" id="input_name">
                            <label class="barlow medium size_18 xs-size_14 ls_0 xs-lh_17 lh_22 xs-mb_5 mb_6" for="name">Name</label>
                            <input type="text" class="form-control rubick" name="name" id="name" required="true">
                        </div>
                    </div>

                    <div class="col m6 xs12 col_gutter15 field_input">
                        <div class="form-group mb_31 xs-mb_15" id="input_email">
                            <label class="barlow medium size_18 xs-size_14 ls_0 xs-lh_17 lh_22 xs-mb_5 mb_6" for="email">Email</label>
                            <input type="text" class="form-control rubick" name="email" id="email" required="true">
                        </div>
                    </div>
                </div>
                ...
                <div class="row row_gutter15">
                    <div class="col m6 xs12 col_gutter15 field_input">
                        <div class="form-group mb_31 xs-mb_15" id="input_phone">
                            <label class="barlow medium size_18 xs-size_14 ls_0 xs-lh_17 lh_22 xs-mb_5 mb_6" for="phone">Phone</label>
                            <input type="text" class="form-control rubick" name="phone" id="phone" required="true">
                        </div>
                    </div>
                </div>

                <div class="row row_gutter15 mb_31 xs-mb_15">
                    <div class="col m12 xs12 col_gutter15 field_input" id="input_message">
                        <label class="barlow medium size_18 xs-size_14 ls_0 xs-lh_17 lh_22 xs-mb_5 mb_6" for="message">Message</label>
                        <textarea class="form-control rubick" name="message" id="message" required="true"></textarea>
                    </div>
                </div>

                <input type="hidden">

                <div class="row row_gutter15 mb_50 xs-mb_30">
                    <div class="col m12 col_gutter15 text-center">
                        <button name="submit" type="button" onclick="addDatabase()" class="btn xs-size_16 size_24 ls_0 lh_29 xs-lh_19 barlow bold btn_w200" id="form-button-save">SEND</button>
                    </div>
                </div>

                <div class="contact-response text-center"></div>
            </form>
        </div>
    </div>
</body>
